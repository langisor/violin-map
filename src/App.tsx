...
import { TUNINGS, buildStrings } from "@/lib/violin-theory";
    ...
    <main className="mx-auto flex min-h-screen max-w-4xl flex-col gap-6 p-6">
      <div>
        ...
        <p className="text-sm text-violin-muted">
          A four-string fingerboard with bowed and pizzicato playback, plus live pitch detection —
          built with Tone.js and tonal.
        </p>
      </div>
      ...
      {view === "play" ? (
        <>
          ...
          <ViolinFingerboard mode={mode} strings={strings} />
